...
import { formatDate } from "../../backend/formatDate.ts"

import db from "../../backend/db.ts";
import { createCalendar } from "../../backend/createCalendar.js";
  ...
  try {
    ...
    return {
      ...
      body: JSON.stringify({ 
        ...
        downloadLink: `data:text/calendar;charset=utf-8,${encodeURIComponent(
          stringCalendar
        )}`,
       }),
    };
